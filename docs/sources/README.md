...
| [`vm22-section-check.md`](vm22-section-check.md) | the same chapter, read **section by section** | as above | every one of the thirteen sections classified: implemented, refused, out of scope, or gap | `engine/report/vm22.py` | ✅ **systematic pass — three further findings**, one fixed, two recorded |
